...
;; $ may start an identifier in Haxe.
...
;; The only type of preprocessor directive is for conditional compilation
...
(c-lang-defconst c-modifier-kwds
  haxe '( "private" "public" "static" "override" "inline" "macro" "extern"))
...
;; Keywords that can follow a class declaration
(c-lang-defconst c-postfix-decl-spec-kwds
  haxe '("extends" "implements"))

;; Functions and variables have their type specified after a colon
(c-lang-defconst c-colon-type-list-kwds
  haxe '("function" "var"))

(c-lang-defconst c-colon-type-list-re
  haxe "[a-zA-Z_$0-9 ]*?\\(var|function\\)\\>")
...
;; No labels besides case and default.
...
;; Functions can be used as lambdas
(c-lang-defconst c-lambda-kwds
  haxe '("function"))

;; These control flow blocks can appear in expression context
(c-lang-defconst c-inexpr-block-kwds
  haxe '("if" "else" "try" "catch" "switch"))

;; Classes can appear inside expressions in macro context (see "class reification").
